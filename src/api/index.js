...
function getSid() {
    return JSON.parse(sessionStorage.getItem('user')).sid
...
export default {
    ...
    post(url, params, cb, errorcb) {
        ...
        header.sid = getSid()
        axios.post(
            rpmApiRoot + url, querystring.stringify(params), {
                headers: header
            }).then((response) => {
    ...
    login(url, params, cb, errorcb) {
        console.log("querystring.stringify(params)", params, querystring.stringify(params))
        axios.post(
            url, querystring.stringify(params)).then((response) => {

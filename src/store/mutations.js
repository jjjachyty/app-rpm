...
export const state = {
    ...
    auth: null,
    message: { code: "", msg: "" },
    toast: { value: false, text: "", code: "" },
    rpmApiRoot: "http://172.168.171.241:9090/api/rpm",
    ssoApiRoot: "http://172.168.171.205:8080/AM",
    approveApiRoot: "http://172.168.171.241:8080/activiti-webapp",
    rpmWebRoot: "http://172.168.171.241:8080/app-rpm",
}
